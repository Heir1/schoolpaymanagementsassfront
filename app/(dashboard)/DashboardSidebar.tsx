...
export default function DashboardSidebar() {
  ...
  const navItems: { href: string; label: string; icon: typeof BookUser; exact?: boolean }[] = [
    ...
    ...(isParent
      ? [
          { href: "/dashboard/children", label: "Mes enfants", icon: BookUser, exact: true },
          { href: "/dashboard/children/link", label: "Lier un enfant", icon: UserPlus },
        ]
      : []),
  ];
