...
export default function NewUserPage() {
  ...
  useEffect(() => {
    ...
    api.admin
      ...
      .catch(() => setError("Impossible de charger la liste des écoles."))
  ...
  return (
    <div className="p-6 lg:p-8">
      ...
      <p className="text-slate-600 mb-8">
        Créer un compte <strong>Administrateur école</strong> (school_admin).
      </p>
      ...
      >
        ...
        <div>
          ...
          >
            <option value="">
              {schoolsLoading ? "Chargement…" : "Sélectionner une école"}
            </option>
            {schools.map((s) => (
