...
export default function NewStudentFeePage() {
  const { user } = useAuth();
  ...
  }, [user?.role.name, router, studentId]);
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    api.admin
      .createStudentFee(token, studentId, body)
  ...
  return (
    <div className="p-6 lg:p-8">
      ...
      <h1 className="font-display text-2xl font-bold text-slate-900 tracking-tight mb-2">
        Ajouter un frais (étudiant)
      </h1>
      <p className="text-slate-600 mb-8">
        Type, montant, échéance. Optionnel : tranches (somme = montant). Pas de classes associées — l&apos;étudiant est déjà lié à une classe.
      </p>
